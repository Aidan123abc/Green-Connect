    ...
    <div className="bg-gray-200 min-h-screen">
      ...
      <div className="w-90% mx-[5%]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 mt-24">
          <div className="w-full lg:1/3 lg:max-w-[300px] justify-self-end">
            <Sidebar />
          </div>
          <div className="w-full lg:2/3 lg:max-w-[700px] mt-4">
            <DashScroll personal={false} email={""} />
          </div>
          <div className="hidden lg:block lg:1/3 lg:max-w-[350px] justify-self-start">
            <DashProfile />
          </div>
        </div>
      </div>
