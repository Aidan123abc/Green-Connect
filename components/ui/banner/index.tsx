  ...
  return (
    <header className="bg-green-800 text-white h-24 flex items-center justify-between text-xl absolute top-0 left-0 w-full z-50">
      <div className="flex flex-row items-center">
        <Link href={'/dashboard'} className="p-4 sm:p-8 font-bold">Green Connect</Link>
        <input
          type="text"
          placeholder="Search..."
      ...
      <div className="pr-4 flex flex-row">
        <div className="flex flex-row pr-4 items-center">
          <Link href={'/dashboard'} className="bg-green-800 text-white hover:bg-green-900 hover:text-grey-200 p-2 sm:p-4 text-xs sm:text-base rounded-md"> Dashboard </Link>
          <Link href={'/about'} className="bg-green-800 text-white hover:bg-green-900 hover:text-grey-200 p-2 sm:p-4 text-xs sm:text-base rounded-md"> About </Link>
          <Link href={'/myItems'} className="bg-green-800 text-white hover:bg-green-900 hover:text-grey-200 p-2 sm:p-4 text-xs sm:text-base rounded-md"> My Items </Link>
        </div>
        <div className="pt-2">
